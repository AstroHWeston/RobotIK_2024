...
Adafruit_NeoPixel::Adafruit_NeoPixel()
    :
      ...
      is800KHz(true),
#endif
      begun(false), numLEDs(0), numBytes(0), pin(-1), brightness(0), pixels(NULL), rOffset(1), gOffset(0), bOffset(2),
      wOffset(1), endTime(0)
{
}
    ...
    if (is800KHz)
    {
        ...
        if (port == &PORTD)
        {
            ...
            asm volatile("headD:"
                         ...
                         : [port] "I"(_SFR_IO_ADDR(PORTD)), [ptr] "e"(ptr), [hi] "r"(hi), [lo] "r"(lo));
            ...
            if (port == &PORTB)
        {
            ...
            asm volatile("headB:"
                         ...
                         "\n"
                         : [byte] "+r"(b), [n1] "+r"(n1), [n2] "+r"(n2), [count] "+w"(i)
                         : [port] "I"(_SFR_IO_ADDR(PORTB)), [ptr] "e"(ptr), [hi] "r"(hi), [lo] "r"(lo));
            ...
            if (port == &PORTC)
        {
            ...
            asm volatile("headC:"
                         ...
                         "\n"
                         : [byte] "+r"(b), [n1] "+r"(n1), [n2] "+r"(n2), [count] "+w"(i)
                         : [port] "I"(_SFR_IO_ADDR(PORTC)), [ptr] "e"(ptr), [hi] "r"(hi), [lo] "r"(lo));
            ...
            if (port == &PORTF)
        {
            ...
            asm volatile("headF:"
                         ...
                         "\n"
                         : [byte] "+r"(b), [n1] "+r"(n1), [n2] "+r"(n2), [count] "+w"(i)
                         : [port] "I"(_SFR_IO_ADDR(PORTF)), [ptr] "e"(ptr), [hi] "r"(hi), [lo] "r"(lo));
...
#define CYCLES_400     (F_CPU_ACTUAL / 400000)
    ...
    asm volatile("L%=_begin:"
                 ...
                 "L%=_done:"
                 "\n\t"
                 : [p] "+r"(p), [pix] "=&r"(pix), [count] "=&r"(count), [dly] "=&r"(dly), [num] "+r"(num)
...
//----
    ...
    asm volatile(
        ...
        : [p] "+r"(p), [pix] "=&r"(pix), [count] "=&r"(count), [mask] "=&r"(mask), [num] "+r"(num)
        : [bitmask] "r"(bitmask), [reg] "r"(reg));
